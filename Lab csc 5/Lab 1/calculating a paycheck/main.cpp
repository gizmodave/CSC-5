...
int main(int argc, char** argv) {
    ...
    fdltx,fdltxtotal;
    ss = .062f;//This is the rate of the current tax for SS 6.20%
    mdcr = .0145f;//This is the rate of the current tax for medicare 1.45%
    ncmtx = .093f;//This is the rate of the current tax for state income 9.30%
    fdltx = .25f;//This is the rate of the current tax for federal income 25%
    //Input Values Here
